...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "Update appointments set full_name='$full_name',email='$email',phone='$phone',service_type='$service_type',appointment_date='',appointment_time, gender,message,status) VALUES ('$full_name','$email','$phone','$service_type','$appointment_date','$appointment_time','$gender','$message','$status')";
