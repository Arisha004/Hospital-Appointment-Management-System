...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "Update appointments set full_name='$full_name',email='$email',phone='$phone',service_type='$service_type',appointment_date='$appointment_date',appointment_time='$appointment_time', gender='$gender',message='$message',status='$status' where id='$id";
