...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($result->num_rows > 0) {
    ...
    /*Wait 3 seconds (refresh:3)
Then go to landingpage.html (url=landingpage.html)
Essentially, it automatically redirects the user after 3 seconds.*/
...
<body>
  ...
  <div class="form1-container">
    ...
    <form method="POST">
      <label>Email:</label>
      <input type="email"  pattern="[a-zA-Z0-9._]+@[a-zA-Z]+\.[a-zA-Z]{3,10}"
